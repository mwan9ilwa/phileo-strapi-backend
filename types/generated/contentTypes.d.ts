...
export interface ApiHomeHome extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    featuredDestinations: Schema.Attribute.Relation<
      'oneToMany',
      'api::destination.destination'
    >;
    featuredTours: Schema.Attribute.Relation<'oneToMany', 'api::tour.tour'>;
...
export interface ApiTourTour extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    bookingLink: Schema.Attribute.Text;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    departureDates: Schema.Attribute.JSON;
    description: Schema.Attribute.Blocks;
    ...
    >;
    duration: Schema.Attribute.Integer;
    excluded: Schema.Attribute.Text;
